...
All apps have a GUI settings menu with a common layout which allows you to interactively edit your settings from within the application.
...
For the above software, if someone with a commercial license was willing to help test the plugins, I would consider writing/maintaining them.
...
Marvelous Designer also lacks threading support, making a plugin impossible.
