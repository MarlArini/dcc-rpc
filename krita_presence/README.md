...
- **Active layer**: the name of the active layer, and sublayer count if nonzero. If the layer name contains 'Layer', e.g., *'Layer 2'*, just the name will appear; if it does not, e.g., *'Shadows'*, it will be prefixed by 'Layer: ', e.g., *'Layer: Shadows'*. The sublayer count, if nonzero, is appended in parentheses and labeled: e.g., *'Layer: Shadows (3 sublayers)'*.
...
- **Color profile**: The color model and profile of the document, with the profile following the model in parentheses, e.g., *'RGBA (sRTB-elle-V2-g10.icc)'*
